...
from finanzmaschine_accounting.portfolio.operations.trade_enum import TradeEnum
from finanzmaschine_accounting.portfolio.records.base_record import BaseRecord
from finanzmaschine_accounting.portfolio.records.mixins.price_fee_mixin import PriceFeeMixin
