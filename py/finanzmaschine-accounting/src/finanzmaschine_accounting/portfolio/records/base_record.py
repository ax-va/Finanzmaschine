...
from finanzmaschine_accounting.portfolio.operations import DirectionEnum
from finanzmaschine_accounting.portfolio.operations.operation import Operation
